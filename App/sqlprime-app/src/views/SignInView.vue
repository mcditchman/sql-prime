  ...
  <div class="bg-gray-100 dark:bg-gray-800 h-screen flex items-center justify-center">
    <div class="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md w-full max-w-md">
      <div class="text-center mb-6">
        <h1 class="text-3xl font-semibold text-gray-800 dark:text-white mb-2">SQLPrime</h1>
        <p class="text-gray-600 dark:text-gray-400 font-medium">Sign in to continue</p>
      </div>
        ...
        <form @submit.prevent="handleLogin">
          <div class="mb-4">
            ...
            <div class="relative">
              ...
              <input
                ...
                v-model="email"
                type="email"
                class="form-input pl-10 dark:bg-gray-800 dark:text-white dark:border-gray-700"
          ...
          <div class="mb-4">
            <div class="flex justify-between mb-2">
              ...
              <router-link to="/forgot-password" class="text-sm text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
                Forgot password?
              </router-link>
            </div>
            <div class="relative">
              ...
              <input
                ...
                class="form-input pl-10 pr-10 dark:bg-gray-800 dark:text-white dark:border-gray-700"
          ...
          <div class="mt-4 text-center">
            ...
            <router-link to="/register" class="ml-1 text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
              Create one
            </router-link>
          </div>
        </form>
